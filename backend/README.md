...
## Project Structure
    ...
    ├── testapiautocatalog_101527  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_101527`
...
2. Clone this repo and `cd testapiautocatalog_101527`
